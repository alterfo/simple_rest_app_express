var load = '<img src="i/load.gif" alt="" id="load"/>'
    ...
    function getUsers() {
        sendData('GET', 'http://10.10.108.113:4000/users', null, function(req) {
            ...
            for (var j = 0; j < elnum; j++) {
                ...
                addEvent(el, 'click', function() {
                    sendData('DELETE', 'http://10.10.108.113:4000/user/' + el.getAttribute('userid'), null, function(response) {
                        getUsers();
                    });
                });
            }
